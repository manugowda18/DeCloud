            ...
            return v.each(function(v) {
                ...
                function U() {
                    ...
                    var b = ea.select(".nv-focus .nv-barsWrap").datum($.length ? $.map(function(a, b) {
                        ...
                        h = ea.select(".nv-focus .nv-linesWrap").datum(S(_) ? [{
                            values: []
                        }] : _.filter(function(a) {
                            return !a.disabled
                        }).map(function(a, b) {
                ...
                var ja = ea.select(".nv-context .nv-barsWrap").datum($.length ? $ : [{
                        values: []
                    }]),
                    ka = ea.select(".nv-context .nv-linesWrap").datum(S(_) ? [{
                        values: []
                    }] : _.filter(function(a) {
                        return !a.disabled
                    }));
        ...
        function b(k) {
            return H.reset(), H.models(e), r && H.models(f), s && H.models(g), k.each(function(k) {
                ...
                e.dispatch.on("areaClick.toggle", function(a) {
                    ...
                    v && "expand" != e.style() && i.length >= 2 && i.push({
                        key: w,
                        value: l,
                        total: !0
                    });

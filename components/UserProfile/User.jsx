            ...
            <div class="card car-transparent">
              <div class="card-body p-0">
                <div class="profile-image position-relative">
                  <img
                    src="../assets/images/page-img/profile.png"
                  ...
                  <div class="card-body">
                    <ul class="list-inline p-0 m-0">
                      <li class="mb-3 d-flex">
                        <span>
                          <i class="lab la-facebook-f text-primary font-size-20 mr-3"></i>
                        </span>
                      ...
                      <li class="mb-3 d-flex">
                        <span>
                          <i class="lab la-twitter text-info font-size-20 mr-3"></i>
                        </span>
                        <p class="mb-0 font-size-16 line-height">
                          @nataliedawson
                        </p>
                      ...
                      <li class="d-flex">
                        <span>
                          <i class="lab la-instagram text-danger font-size-20 mr-3"></i>
                        </span>
                        <p class="mb-0 font-size-16 line-height">
                          @natalietweets
                        </p>
                  ...
                  <div class="card-body">
                    <ul class="list-inline mb-0 p-0">
                      <li class="d-flex align-items-center mb-3">
                        <span class="bg-danger rounded-small iq-card-icon-small mr-3">
                          1
                        </span>
                        <p class="mb-0 font-size-16">
                          Software Engineer at Mathica Labs | 2018 - present
                        </p>
                      </li>
                      <li class="d-flex align-items-center">
                        <span class="bg-primary rounded-small iq-card-icon-small mr-3">
                          2
                        </span>
                        <p class="mb-0 font-size-16">
                          Junior Software Engineer at Zimcore Solutions | 2015 -
                          2018
                        </p>
                      </li>
                    </ul>
            ...
            <div class="card card-block card-stretch card-height">
              ...
              <div class="card-body">
                <ul class="list-inline p-0 m-0 iq-contact-rest">
                  <li class="mb-3 d-flex">
                    <span>
                      <i class="fas fa-map-marker-alt mr-3 font-size-20"></i>
                    </span>
                    <p class="mb-0 font-size-16 line-height">
                      505 West Brickyard Rd, CA , USA
                    </p>
                  </li>
                  <li class="mb-3 d-flex">
                    <span>
                      <i class="fas fa-phone-volume mr-3 font-size-20"></i>
                    </span>
                    <p class="mb-0 font-size-16 line-height">+91 01234 56789</p>
                  </li>
                  <li class="mb-3 d-flex">
                    <span>
                      <i class="fas fa-envelope-open mr-3 font-size-20"></i>
                    </span>
                    <p class="mb-0 font-size-16 line-height">
                      john@property.com
                    </p>
                  ...
                  <li class="d-flex">
                    <span>
                      <i class="fas fa-briefcase mr-3 font-size-20"></i>
                    </span>
                    <p class="mb-0 font-size-16 line-height">
                      9486 Roberts St. Monroe Township.
                    </p>
                  </li>
                </ul>
              </div>
